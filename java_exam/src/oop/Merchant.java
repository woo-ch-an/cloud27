...
public class Merchant {
	// 판매자꺼
		...
		public Merchant (int mistorageItem, int mifoundation, int miitemPrice) {
			this.mistorageItem = mistorageItem; // 상품 갯수
			this.mifoundation = mifoundation; // 초기자본
		...
		public void sellItem(int iproductCount) {
			...
			System.out.println(	"판매자의 재고 수 : " + mistorageItem + 
								" 판매자의 자본금 : " + mifoundation);
		}
	}
}