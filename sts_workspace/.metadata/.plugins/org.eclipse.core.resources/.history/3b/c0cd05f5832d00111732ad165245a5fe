...
<head>
<meta charset="UTF-8">
<script type="text/javascript" src="/js/jquery-4.0.0.slim.min.js"></script><script type="text/javascript" src="/js/board.js"></script>
	...
	<form method="post" action="/write" enctype="multipart/form-data">
		<div class="gird write">
			<label for="subject">제목</label> <input type="text" id="subject"
				name="subject" placeholder="Write your title" /> <label for="email">이메일</label>
			<input id="email" type="email" name="email"
				...
				<div id="attach-files" class="attach-files">
					...
					<button type="button" class="add-file">+</button> </div>
