...
public class RepliesController {
	...
	@GetMapping("/reply/delete/all/{boardId}")
	public String doDeleteAllReplyAction(@PathVariable String boardId) {
		
		boolean deleteResult = this.repliesService.deleteAllReplyByBoardid(boardId);
		return "redirect:/view/"+boardId; // 새로고침 키 뭐 없나
	}
